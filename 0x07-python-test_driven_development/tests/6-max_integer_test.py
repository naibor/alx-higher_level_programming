#!/usr/bin/python3
"""unitest for 6-max_integer module
"""
import unittest
...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_max_integer_empty(self):
        """
        test case when an empty list is passed
        without arguments
        """
        test_list = []
    ...
    def test_max_integer_one(self):
        """
        test case when list just have one element
        without arguments
        """
        test_list = [3]
        self.assertEqual(max_integer(test_list), max(test_list))
    ...
    def test_max_integer_first(self):
        """
        test case when the first element is the max
        without arguments
        """
        test_list = [5, 1, 4, 2]
        self.assertEqual(max_integer(test_list), max(test_list))
    ...
    def test_max_integer_last(self):
        """
        test case when the last element is the max
        without arguments
        """
